...
export default function Home() {
    ...
    return (
        <Box sx={{ p: { xs: 2, md: 3 }, maxWidth: 1400, mx: 'auto', pb: '150px' }}>
            <Box sx={{ mb: 4 }}>
            ...
            <Box sx={{ mb: 4 }}>
                <Typography variant="h6" sx={{ mb: 1, fontWeight: 600, color: '#424242', fontSize: '1.1rem' }}>
                    Status dos Extratores
                </Typography>
                <Typography variant="body2" color="textSecondary">O painel de status foi movido para uma página dedicada para melhor visualização e histórico. <a href="#/status-extratores">Abrir página de Extratores</a></Typography>
            </Box>
